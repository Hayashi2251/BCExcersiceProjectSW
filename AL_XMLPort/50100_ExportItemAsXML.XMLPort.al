xmlport 50100 ExportItemAsXML
{
    Direction = Export;
    Format = Xml;
    UseRequestPage = false;
    Caption = 'Export Item(s) to XML';
    Description = 'Create XMLPort to Export Item as XML - Reference of Excercise Project 8-1';
        ...
        textelement(Items)
        {
            tableelement(Item; Item)
            {
                ...
                tableelement(ItemComments; "Item Comment")
                {
                    ...
                    fieldattribute(ItemNo_; Item."No.") { }
